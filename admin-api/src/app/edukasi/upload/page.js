...
export default function EditVideoPage() {
  ...
  // Simulasi Progress Bar (Naik pelan-pelan sampai 95%)
  useEffect(() => {
  ...
  // Hitung teks ukuran (Contoh: 3.5MB / 5.0MB)
  ...
  const handleUnggah = async () => {
    ...
    const videoData = {
      judul: judul,
      isi: deskripsi || "/placeholder-video", // Simpan link dummy karena belum ada storage
      kategori: "video"
    };
