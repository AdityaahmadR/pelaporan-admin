  ...
  return (
    <div className={detailStyles.container}>
      ...
      <div className={detailStyles.pelaporCard}>
        <div className={detailStyles.avatar}>{laporan.nama_pelapor?.[0] || 'A'}</div>
        <div>
        ...
        <div className={detailStyles.waktu}>
          ...
          <br /><strong>1 menit lalu</strong>
        </div>
      </div>

      <div className={detailStyles.isiLaporan}>{isiBersih || 'Tidak ada deskripsi.'}</div>
